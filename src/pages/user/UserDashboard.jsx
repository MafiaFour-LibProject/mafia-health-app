...
import { CalendarDays, MapPin, User, HelpCircle, BookOpen } from "lucide-react";
...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        {/* Header Section with Dark Blue/Cyan Accents */}
        ...
        {/* Facilities Section with Stronger Accent */}
